 ...
 *
 *
 * Class to convert and extract data from hex intel object file
 * Full documentation of this format is on: http://microsym.com/editor/assets/intelhex.pdf
 */
...
public class IntelHex {
     ...
     * */
    public LinkedList compareHexFile(){
    ...
    private LinkedList fileToLinkedList(String path){
        LinkedList<String> list = new LinkedList<>();
    ...
    /**
     * getStartCode return first byte(one char in ASCI) of block of data(named record as well) in intel hex object format file. This bite must contain
     * colon ":". If it dasn't contain colon return null value.
     * */
    ...
    /**
     * getByteCount(Reclen field in the record) return. This field contain number bytes of data in the record.
     * Reclen field has 2 bytes(4 haracters in hex)
     * */
    ...
    /**
     *getAddres return address in the memory, type of addres. Is used only in records contain data. It's mean olly when
     *  rectype is 00.
     * */
    ...
    /**
     * getRecordType return 1B(2 character) contein  type of record
     *  - '00' (0h00, dec: 0, bin: 0000 0000)  record contain data and 16 bit address
     *  - '01' (0h01, dec: 1, bin: 0000 0001) end of file record
     *  - '02' (0h02, dec: 2, bin: 0000 0010) Extended segment address record
     *  - '03' (0h03, dec: 3, bin: 0000 0011)
     *  - '04' (0h04, dec: 4, bin: 0000 0100)
     *  - '05' (0h05, dec: 5, bin: 0000 0101)
     * */
